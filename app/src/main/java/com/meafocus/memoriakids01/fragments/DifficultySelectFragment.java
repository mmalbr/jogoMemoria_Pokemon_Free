package com.meafocus.memoriakids01.fragments;
...
import com.meafocus.memoriakids01.common.Memory;
...
import com.meafocus.memoriakids01.ui.DifficultyView;
...
public class DifficultySelectFragment extends Fragment {
    ...
    private String getBestTimeForStage(int theme, int difficulty) {
        ...
        if (bestTime != -1) {
            ...
            @SuppressLint("DefaultLocale") String result = String.format("MELHOR : %02d:%02d", minutes, seconds);
            return result;
        } else {
            return "MELHOR : -";
        }
    ...
    private void animate(View... view) {
        ...
        for (View value : view) {
            ObjectAnimator scaleX = ObjectAnimator.ofFloat(value, "scaleX", 0.8f, 1f);
            ObjectAnimator scaleY = ObjectAnimator.ofFloat(value, "scaleY", 0.8f, 1f);
