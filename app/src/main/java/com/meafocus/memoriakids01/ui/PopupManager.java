...
public class PopupManager {
	...
	public static void showPopupNoAds() {
		...
		// popup
		PopupAdsView popupAdsView = new PopupAdsView(Shared.context);
		int width = Shared.context.getResources().getDimensionPixelSize(R.dimen.popup_ads_width);
		int height = Shared.context.getResources().getDimensionPixelSize(R.dimen.popup_ads_height);
		RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(width, height);
		params.addRule(RelativeLayout.CENTER_IN_PARENT);
		popupContainer.addView(popupAdsView, params);

		// animate all together
		ObjectAnimator scaleXAnimator = ObjectAnimator.ofFloat(popupAdsView, "scaleX", 0f, 1f);
		ObjectAnimator scaleYAnimator = ObjectAnimator.ofFloat(popupAdsView, "scaleY", 0f, 1f);
	...
	public static void showPopupGames() {
		RelativeLayout popupContainer = (RelativeLayout) Shared.activity.findViewById(R.id.popup_container);
		popupContainer.removeAllViews();
		...
		// popup
		PopupGameView popupGameView = new PopupGameView(Shared.context);
		int width = Shared.context.getResources().getDimensionPixelSize(R.dimen.popup_games_width);
		int height = Shared.context.getResources().getDimensionPixelSize(R.dimen.popup_games_height);
		RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(width, height);
		params.addRule(RelativeLayout.CENTER_IN_PARENT);
		popupContainer.addView(popupGameView, params);

		// animate all together
		ObjectAnimator scaleXAnimator = ObjectAnimator.ofFloat(popupGameView, "scaleX", 0f, 1f);
		ObjectAnimator scaleYAnimator = ObjectAnimator.ofFloat(popupGameView, "scaleY", 0f, 1f);
		ObjectAnimator alphaAnimator = ObjectAnimator.ofFloat(imageView, "alpha", 0f, 1f);
		AnimatorSet animatorSet = new AnimatorSet();
		animatorSet.playTogether(scaleXAnimator, scaleYAnimator, alphaAnimator);
		animatorSet.setDuration(500);
